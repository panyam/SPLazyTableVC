...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SPLazyTableVC.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SPLazyTableVC'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sriram Panyam' => 'sri.panyam@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SPLazyTableVC.git', :tag => s.version.to_s }
